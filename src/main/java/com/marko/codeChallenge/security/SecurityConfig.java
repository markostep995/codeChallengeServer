...
import static com.marko.codeChallenge.security.SecurityConstants.SIGN_UP_URSL;
import static com.marko.codeChallenge.security.SecurityConstants.SIGN_UP_WITH_CERTIFICATE_URL;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(SIGN_UP_URSL).permitAll().antMatchers(SIGN_UP_WITH_CERTIFICATE_URL).permitAll()
